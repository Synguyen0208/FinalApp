import { Image, StyleSheet, Text, TextInput, View,Modal, Alert,Button, Pressable, TouchableOpacity } from 'react-native';
        ...
        <View style={styles.container}>
            ...
            >
                <View style={styles.viewModel}>
                    ...
                    <Text  style={{textAlign:'center',color:'#696974',lineHeight: 25,}}>
                    Reset link has been sent to “goodstartearlylearning@gmail.com”
                    </Text>
                    </View>
                        <TouchableOpacity style={styles.buttonOK} onPress={()=>setModalhiden(false)}>
            ...
            <Text style={styles.detail}>Please enter your email address to get reset link</Text>
